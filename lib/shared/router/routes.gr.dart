...
import 'package:tarbus_app/data/model/schedule/track.dart' as _i25;
...
import 'package:tarbus_app/views/pages/app_home_page/app_home_page.dart'
    as _i16;
import 'package:tarbus_app/views/pages/app_map_page/app_map_page.dart' as _i18;
...
import 'package:tarbus_app/views/pages/app_search_page/app_search_page.dart'
    as _i19;
import 'package:tarbus_app/views/pages/app_wrapper.dart' as _i14;
...
import 'package:tarbus_app/views/pages/map_track_page/track_map_page.dart'
    as _i7;
import 'package:tarbus_app/views/pages/not_found.dart' as _i15;
...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    AppRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i14.AppWrapper());
    },
    NotFoundRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i15.NotFoundPage());
    },
    AppHomeRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i16.AppHomePage());
    },
    AppBusLinesWrapper.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i17.AppBusLinesWrapper());
    },
    AppMapRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i18.AppMapPage());
    },
    AppSearchRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i19.AppSearchPage());
    },
    AppMenuRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i20.AppMenuPage());
    },
    AppBusLinesRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i21.AppBusLinesPage());
    },
    LineDetailsRoute.name: (routeData) {
      final args = routeData.argsAs<LineDetailsRouteArgs>();
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i22.LineDetailsPage(
              key: args.key,
              busLineId: args.busLineId,
              busLineName: args.busLineName));
    }
...
class SearchListRoute extends _i1.PageRouteInfo<SearchListRouteArgs> {
  SearchListRoute(
      {_i23.Key? key, dynamic Function(_i24.BusStop)? onBusStopSelected})
      : super(name,
            path: '/search',
...
class SearchListRouteArgs {
  ...
  final dynamic Function(_i24.BusStop)? onBusStopSelected;
}

class TrackMapRoute extends _i1.PageRouteInfo<TrackMapRouteArgs> {
  TrackMapRoute(
      {_i23.Key? key, required _i25.Track track, required _i24.BusStop busStop})
      : super(name,
            path: '/track-map',
