...
import 'package:tarbus_app/data/model/schedule/departure.dart' as _i28;
...
import 'package:tarbus_app/views/pages/app_home_page/app_home_page.dart'
    as _i18;
import 'package:tarbus_app/views/pages/app_map_page/app_map_page.dart' as _i20;
...
import 'package:tarbus_app/views/pages/app_search_page/app_search_page.dart'
    as _i21;
import 'package:tarbus_app/views/pages/app_wrapper.dart' as _i16;
...
import 'package:tarbus_app/views/pages/map_track_page/track_map_page.dart'
    as _i7;
import 'package:tarbus_app/views/pages/not_found.dart' as _i17;
import 'package:tarbus_app/views/pages/permission_page.dart' as _i13;
import 'package:tarbus_app/views/pages/search_list_page/search_list_page.dart'
    as _i6;
import 'package:tarbus_app/views/pages/settings_page/settings_page.dart' as _i8;
...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    SearchListRoute.name: (routeData) {
      ...
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i6.SearchListPage(key: args.key, type: args.type));
    },
    ...
    MapRouteStopsRoute.name: (routeData) {
      ...
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i10.MapRouteStopsPage(key: args.key, route: args.route));
    },
    DeparturesRoute.name: (routeData) {
      final args = routeData.argsAs<DeparturesRouteArgs>();
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i11.DeparturesPage(
              key: args.key,
    ...
    DepartureDetailsRoute.name: (routeData) {
      ...
      return _i1.CustomPage<dynamic>(
          routeData: routeData,
          child: _i12.DepartureDetailsPage(
    ...
    AppRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i16.AppWrapper());
    },
    NotFoundRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i17.NotFoundPage());
    },
    AppHomeRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i18.AppHomePage());
    },
    AppBusLinesRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i19.AppBusLinesPage());
    },
    AppMapRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i20.AppMapPage());
    },
    AppSearchRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i21.AppSearchPage());
    },
    AppMenuRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i22.AppMenuPage());
    }
  };
  ...
  List<_i1.RouteConfig> get routes => [
        ...
        _i1.RouteConfig(AddFavouriteBusStopRoute.name,
        ...
        _i1.RouteConfig(AppRoute.name, path: '/app', guards: [
          ...
          _i1.RouteConfig(AppBusLinesRoute.name, path: 'lines'),
...
class SearchListRoute extends _i1.PageRouteInfo<SearchListRouteArgs> {
  SearchListRoute({_i23.Key? key, required String type})
      : super(name,
            path: '/search', args: SearchListRouteArgs(key: key, type: type));

  static const String name = 'SearchListRoute';
}

class SearchListRouteArgs {
  const SearchListRouteArgs({this.key, required this.type});
...
class DepartureDetailsRoute
  ...
  DepartureDetailsRoute({_i23.Key? key, required _i28.Departure departure})
      : super(name,
...
class DepartureDetailsRouteArgs {
  ...
  final _i28.Departure departure;
}
...
class AddFavouriteBusStopRoute
    extends _i1.PageRouteInfo<AddFavouriteBusStopRouteArgs> {
