...
import 'package:tarbus_app/data/model/schedule/bus_line.dart' as _i21;
import 'package:tarbus_app/data/model/schedule/bus_stop.dart' as _i20;
import 'package:tarbus_app/data/model/schedule/departure.dart' as _i22;
...
import 'package:tarbus_app/views/pages/app_home_page/app_home_page.dart'
    as _i12;
import 'package:tarbus_app/views/pages/app_map_page/app_map_page.dart' as _i14;
...
import 'package:tarbus_app/views/pages/app_search_page/app_search_page.dart'
    as _i15;
import 'package:tarbus_app/views/pages/app_wrapper.dart' as _i10;
...
import 'package:tarbus_app/views/pages/line_details_page/line_details_page.dart'
    as _i18;
import 'package:tarbus_app/views/pages/not_found.dart' as _i11;
import 'package:tarbus_app/views/pages/permission_page.dart' as _i9;
...
class AppRouter extends _i1.RootStackRouter {
  ...
  final Map<String, _i1.PageFactory> pagesMap = {
    ...
    DepartureDetailsRoute.name: (routeData) {
      ...
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i8.DepartureDetailsPage(
              key: args.key, departure: args.departure));
    },
    PermissionsRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i9.PermissionPage());
    },
    AppRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i10.AppWrapper());
    },
    NotFoundRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i11.NotFoundPage());
    },
    AppHomeRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i12.AppHomePage());
    },
    AppBusLinesWrapper.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i13.AppBusLinesWrapper());
    },
    AppMapRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i14.AppMapPage());
    },
    AppSearchRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i15.AppSearchPage());
    },
    AppMenuRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i16.AppMenuPage());
    },
    AppBusLinesRoute.name: (routeData) {
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData, child: _i17.AppBusLinesPage());
    },
    LineDetailsRoute.name: (routeData) {
      final args = routeData.argsAs<LineDetailsRouteArgs>();
      return _i1.AdaptivePage<dynamic>(
          routeData: routeData,
          child: _i18.LineDetailsPage(
              key: args.key,
...
class SearchListRoute extends _i1.PageRouteInfo<SearchListRouteArgs> {
  SearchListRoute(
      {_i19.Key? key, dynamic Function(_i20.BusStop)? onBusStopSelected})
      : super(name,
            path: '/search',
...
class SearchListRouteArgs {
  ...
  final dynamic Function(_i20.BusStop)? onBusStopSelected;
}
...
class DeparturesRouteArgs {
  ...
  final _i21.BusLine? busLine;
}

class DepartureDetailsRoute
    extends _i1.PageRouteInfo<DepartureDetailsRouteArgs> {
  DepartureDetailsRoute({_i19.Key? key, required _i22.Departure departure})
      : super(name,
...
class DepartureDetailsRouteArgs {
  ...
  final _i22.Departure departure;
}
...
class LineDetailsRoute extends _i1.PageRouteInfo<LineDetailsRouteArgs> {
  LineDetailsRoute(
      {_i19.Key? key, required int busLineId, required String busLineName})
      : super(name,
            path: 'routes',
