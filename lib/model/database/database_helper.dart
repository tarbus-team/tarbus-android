...
// only have a single app-wide reference to the database
  ...
  Future<List<Departure>> getNextDeparturesWithLimit(
      int busStopId, String dayTypes, int startFromTime, int limit) async {
    var dayTypesQuery = dayTypes.split(' ');
    var queryFragment = StringBuffer();
    var isFirstIteration = true;
    for (var dayType in dayTypesQuery) {
  ...
  Future<String> getTrackCoords(int idFrom, int idTo) async {
  ...
  Future<List<Departure>> getDeparturesByRouteAndDay(
      List<String> dayTypes, TrackRoute trackRoute, int busStopId) async {
    var queryFragment = StringBuffer();
    var isFirstIteration = true;
